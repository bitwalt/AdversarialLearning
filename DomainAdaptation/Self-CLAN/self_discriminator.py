...
class Self_CLAN:
    def __init__(self, args, logger):
        ...
        if args.method.self:
            self.model_A = get_auxiliary_net(args.auxiliary.name)(input_dim=args.auxiliary.classes, aux_classes=args.auxiliary.aux_classes, classes=args.auxiliary.classes)
