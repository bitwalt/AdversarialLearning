...
class ResNet(nn.Module):
    def __init__(self, block, layers, input_dim, aux_classes=4):
        self.inplanes = 64
        ...
        #self.aux_classifier = nn.Linear(512 * aux_classes, aux_classes)  # 226x256
        self.aux_classifier = nn.Linear(2048*25, aux_classes)  # 512x512
    ...
    def forward(self, x, **kwargs):
        ...
        x = x.view(x.size(0), -1)
        # print('x_view ', x.size())
        # print('class', self.aux_classifier(x))
