...
def main():
    ...
    create_dirs([config.snapshot_dir, config.prediction_dir, config.results], config.exp_name)
    ...
    options = ['segmenation', 'CLAN', 'Self-Supervised', 'Self-CLAN']
    ...
    src_loader = get_train_dataloader(config.datasets.src)
