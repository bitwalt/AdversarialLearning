...
RESTORE_FROM = './snapshots/5000/GTA5_6000.pth'
RESTORE_FROM_D = './snapshots/5000/GTA5_6000_D.pth'
...
NUM_STEPS = 1
NUM_STEPS_STOP = 4000  # Use damping instead of early stopping
...
DATA_DIRECTORY = './dataset/debug/gta5'
DATA_LIST_PATH = './dataset/gta5_list/debug.txt'


TARGET = 'cityscapes'
INPUT_SIZE_TARGET = [1024, 512]
DATA_DIRECTORY_TARGET = './dataset/debug/cityscapes'
DATA_LIST_PATH_TARGET = './dataset/cityscapes_list/debug.txt'
...
LOG_DIR = './log'
LOG_FILE = 'log/debug.txt'  # INSERT EXPERIMENT NAME HERE
...
def main():
    ...
    for i_iter in range(args.num_steps):
        ...
        if i_iter % args.save_pred_every == 0 and i_iter != 0:
            ...
            torch.save(model.state_dict(), osp.join(args.snapshot_dir, 'GTA5_' + str(i_iter+6000) + '.pth'))
            torch.save(model_D.state_dict(), osp.join(args.snapshot_dir, 'GTA5_' + str(i_iter+6000) + '_D.pth'))
